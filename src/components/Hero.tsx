...
interface ProfileData {
  ...
  satyaLabs: { linkedin: string; instagram: string; github: string; youtube: string; huggingface: string; website: string };
}
        ...
        >
          <div className="max-w-screen-xl mx-auto">
            ...
            <p className="flex justify-center mb-5 sm:mb-6">
              <BlurText
                text="AI/ML Enthusiast | Python Developer | Software Engineer"
                delay={60}
                animateBy="words"
                direction="bottom"
