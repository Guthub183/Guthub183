...
const socialLinks = [
  { name: "GitHub", icon: Github, href: staticProfile.socials.github, handle: "@Guthub183" },
  { name: "LinkedIn", icon: Linkedin, href: staticProfile.socials.linkedin, handle: "@k-satya-pranav" },
];
